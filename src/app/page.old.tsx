...
export default function HomePage() {
  ...
  return (
    <Layout>
      <section className="bg-[linear-gradient(30deg,var(--color-red1),var(--color-purple1),var(--color-blue1))] w-full py-0 overflow-hidden">
	  ...
	  <section className="bg-[linear-gradient(130deg,var(--color-red1),var(--color-purple1),var(--color-blue1))] w-full py-0 overflow-hidden">
      <div className="py-10 px-10 grid md:grid-cols-3 gap-6 text-white">
