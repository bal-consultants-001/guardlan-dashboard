		...
		<div className="max-w-6xl mx-auto text-center space-y-6">
		  ...
		  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
			  ...
			  <div className="aspect-[3/2] w-full max-w-md mx-auto">
				...
				/>
				<p className="mt-2 text-lg font-semibold text-red-300 text-center">
				  Without GuardLAN (Ads Active)
				</p>
			  </div>
			  ...
			  <div className="aspect-[3/2] w-full max-w-md mx-auto">
				<Image
				  ...
				  sizes="(max-width: 768px) 100vw, 50vw"
				/>
				<p className="mt-2 text-lg font-semibold text-green-300 text-center">
				  With GuardLAN (Ads Blocked)
				</p>
			  </div>
			</div>
		</div>
